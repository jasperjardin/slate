<?php
/**
 * Custom type error exceptions class
 *
 * @package     Slate
 ...
 * Custom type error exceptions class
 *
 * Indicates invalid argument or return value type received.
 */
final class Type_Error extends TypeError {
	/**
	...
	/**
	 * Constructor for type error exception.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-19
	...
	/**
	 * Overwrite the "TypeError" class "__toString" method.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-19
	...
	public function __toString() {
		return '<strong>Type Error:</strong> ' . $this->error_details;
	}
}
