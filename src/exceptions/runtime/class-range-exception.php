 ...
 * Custom range exceptions class
 *
 * Indicates an internal arithmetic error occurred.
 */
final class Range_Exception extends RangeException {
	/**
	...
	/**
	 * Constructor for range exception.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-24
	...
	/**
	 * Overwrite the "RangeException" class "__toString" method.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-24
	...
	public function __toString() {
		return '<strong>Range Exception:</strong> ' . $this->error_details;
	}
}
