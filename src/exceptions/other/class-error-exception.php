 ...
 * Custom error exceptions class
 *
 * Used by PHP's error handler to convert a standard PHP error into a catchable exception.
 */
final class Error_Exception extends ErrorException {
	/**
	...
	/**
	 * Constructor for error exception.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-19
	...
	/**
	 * Overwrite the "ErrorException" class "__toString" method.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-19
	...
	public function __toString() {
		return '<strong>Error Exception:</strong> ' . $this->error_details;
	}
}
