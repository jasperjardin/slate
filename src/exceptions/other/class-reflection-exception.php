<?php
/**
 * Custom reflection exceptions class
 *
 * @package     Slate
 ...
 * Custom reflection exceptions class
 *
 * Indicates error during reflection operations.
 */
final class Reflection_Exception extends ReflectionException {
	/**
	...
	/**
	 * Constructor for reflection exception.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-24
	...
	/**
	 * Overwrite the "ReflectionException" class "__toString" method.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-24
	...
	public function __toString() {
		return '<strong>Reflection Exception:</strong> ' . $this->error_details;
	}
}
