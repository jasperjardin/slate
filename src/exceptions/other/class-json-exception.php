 ...
 * Custom JSON exceptions class
 *
 * Indicates error during JSON encoding or decoding (PHP 7.3+).
 */
final class Json_Exception extends JsonException {
	/**
	...
	/**
	 * Overwrite the "JsonException" class "__toString" method.
	 *
	 * @since		0.0.1
	 * @author		Jasper Jardin
	 * @created_at	2025-10-19
	...
	public function __toString() {
		return '<strong>JSON Exception:</strong> ' . $this->error_details;
	}
}
