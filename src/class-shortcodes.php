<?php
/**
 * This class is executes all the program shortcodes.
 *
 * This class defines all code necessary to initialize the shortcodes of the program.
 *
 * @package     Slate
 ...
 * This class defines all code necessary to initialize the shortcodes of the program.
 */
final class Shortcodes extends Component_Loader {
	/**
	 ...
	 */
	protected $component_directory_name = 'shortcodes';
	 ...
	 */
	protected $filter_key = 'shortcodes';
