<?php
/**
 * This class is executes all the program post types.
 *
 * This class defines all code necessary to initialize the custom post types of the program.
 *
 * @package     Slate
 * @subpackage  Slate/Src
 * @category    Slate/Src/Post_Types
 ...
 * This class defines all code necessary to initialize the custom post types of the program.
 */
final class Post_Types extends Component_Loader {
	/**
	 ...
	 */
	protected $component_directory_name = 'post-types';
	 ...
	 */
	protected $filter_key = 'post_types';
