<?php
/**
 * This class is executes all the program taxonomies.
 *
 * This class defines all code necessary to initialize the custom taxonomies of the program.
 *
 * @package     Slate
 * @subpackage  Slate/Src
 * @category    Slate/Src/Taxonomies
 ...
 * This class defines all code necessary to initialize the custom taxonomies of the program.
 */
final class Taxonomies extends Component_Loader {
	/**
	 ...
	 */
	protected $component_directory_name = 'taxonomies';
	 ...
	 */
	protected $filter_key = 'taxonomies';
